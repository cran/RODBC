...
included in the OS X SDK.  The CRAN OS X binary package (for 10.6 to
10.8) is compiled against iODBC.
...
sources under OS X: the latter requires configuring with
...
OS X drivers for the MySQL, PostgreSQL and the major commercial
